...
Download the latest production build files: main.js, manifest.json, and styles.css.

Navigate to your Obsidian vault directory.

Open the hidden .obsidian/plugins/ folder.

Create a new folder named direct-github-sync.

Place the three downloaded files into this new folder.

Restart Obsidian, open Settings > Community Plugins, and enable "Direct GitHub Sync".
...
Give the token a descriptive name (e.g., "Obsidian Vault Sync").

Under the "Scopes" section, check the box next to repo (Full control of private repositories).
...
Setup
Clone the repository to a local development folder.
